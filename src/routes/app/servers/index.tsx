      ...
      <div className="flex items-center justify-between">
        ...
        <ResponsiveDialog open={open} onOpenChange={setOpen}
          ...
          <div className="space-y-4">
            <div className="space-y-1.5"><Label>Nome</Label><Input value={name} onChange={(e)=>setName(e.target.value)} maxLength={48} placeholder="Minha panela" className="h-10" /></div>
            ...
            <Button className="w-full h-10" onClick={create} disabled={creating || !name.trim() || !slugOk}>
